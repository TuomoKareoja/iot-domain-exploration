...
\begin{itemize}
    \item Minute level readings from 3 submeters and overall energy usage between December 2006 and November 2010 in a house in Sceaux
    \uncover<2->{
...
\uncover<2->{
    \medskip
    {
        ...
        \footnotesize Submeter-level energy use has distinctive on/off states that are impossible to predict
        \par
    }
}
